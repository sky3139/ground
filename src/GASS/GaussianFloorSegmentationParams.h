...
namespace pcl
{
    struct GaussianFloorSegmentationParams
    {
        ...
        GaussianFloorSegmentationParams(double rmax, int max_bin_points, int num_seed_points, int num_bins_a,
            ...
            : rmax_(rmax), max_bin_points_(max_bin_points), num_seed_points_(num_seed_points), num_bins_a_(num_bins_a), num_bins_l_(num_bins_l), p_l_(p_l), p_sf_(p_sf), p_sn_(p_sn), p_tmodel_(p_tmodel), p_tdata_(p_tdata), p_tg_(p_tg), robot_height_(robot_height), max_seed_range_(max_seed_range), max_seed_height_(max_seed_height)
        {
        }
